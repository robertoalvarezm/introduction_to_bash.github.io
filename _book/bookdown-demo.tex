...
\hypersetup{
  pdftitle={Una introducción a bash},
...
\chapter{Instrucciones básicas}\label{instrucciones-buxe1sicas}}

\hypertarget{listar}{%
\section{Listar}\label{listar}}

\textbf{L}i\textbf{s}tar lo que se tiene en un directorio
